...
$(".qtybutton").on("click", function () {
    ...
    // $('.cart-product-subtotal').text(total);
    ...
    // loadCarts(); //tại sao đưa thằng này vào là bị phải refresh
});


//xem lại thằng này

// function cartProductSubtotal() {
//     let tr = $(this).parents('tr');
//     let id = $(tr).data('id');
//     console.log("id1", id);
//     let cart = carts.find(c => c.productId == id);
...
//     total = (cart.quantity * cart.price);
//     console.log("tong1", total);


//     $('.cart-product-subtotal').html(total);
// }
